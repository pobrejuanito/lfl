...
<script type="text/javascript" src="/media/widgetkit/widgets/slideshow/styles/book-store-weekly/js/reflex.js"></script>

<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-weekly" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	<div>
		<ul class="slides">
