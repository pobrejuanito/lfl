...
<script>
	jQuery(document).ready(function() {
			$(".wk-slideset").attr('style', '');
	
	
	  });
</script>

<div id="showcase-<?php echo $widget_id; ?>" class="wk-slideshow-bookstore" data-widgetkit="showcase" data-options='<?php echo json_encode($settings); ?>'>
