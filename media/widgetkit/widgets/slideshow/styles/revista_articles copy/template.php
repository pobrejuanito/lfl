...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-revista-articles-copy" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	<div>
		<ul class="slides">
			...
			<?php
			$j= $i+1;
				$navigation[] = '<li><span>'.$j.'/'.count($widget->items).'</span></li>';
