...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-revista-tabs-copy" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
