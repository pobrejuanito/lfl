...
switch (count($modules)) {
	...
	case 2:
		...
		printf('<div class="grid-box width60 grid-h">%s</div>', $modules[1]);
		break;

	case 3:
		printf('<div class="grid-box width60 grid-h">%s</div>', $modules[0]);
		printf('<div class="grid-box width23 grid-h">%s</div>', $modules[1]);
		printf('<div class="grid-box width17 grid-h">%s</div>', $modules[2]);
		break;

	case 4:
		printf('<div class="grid-box width25 grid-h">%s</div>', $modules[0]);
		printf('<div class="grid-box width35 grid-h">%s</div>', $modules[1]);
		printf('<div class="grid-box width23 grid-h">%s</div>', $modules[2]);
		printf('<div class="grid-box width17 grid-h">%s</div>', $modules[3]);
		break;
