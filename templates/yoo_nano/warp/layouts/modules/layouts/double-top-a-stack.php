...
switch (count($modules)) {
	...
	case 3:
		printf('<div class="grid-box width70 grid-h">%s</div>', $modules[0]);
		printf('<div class="grid-box width30 grid-h" >
					<div class="grid-box width100 grid-v">%s</div>', $modules[1]);
		printf('<div class="grid-box width100 grid-v">%s</div></div>', $modules[2]);
		break;
