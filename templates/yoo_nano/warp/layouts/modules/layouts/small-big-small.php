...
switch (count($modules)) {
	...
	case 3:
		printf('<div class="grid-box width27 grid-h">%s</div>', $modules[0]);
		printf('<div class="grid-box width46 grid-h">%s</div>', $modules[1]);
		printf('<div class="grid-box width27 grid-h">%s</div>', $modules[2]);
		break;
