...
switch (count($modules)) {
	...
	case 4:
		printf('<div class="grid-box width24 grid-h">%s</div>', $modules[0]);
		printf('<div class="grid-box width24 grid-h">%s</div>', $modules[1]);
		printf('<div class="grid-box width24 grid-h">%s</div>', $modules[2]);
		printf('<div class="grid-box width27 grid-h">%s</div>', $modules[3]);
		break;
