...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="zebra" cellspacing="0" cellpadding="0" border="0" style="width:670px; margin:7px;">
		...
		<thead>
			<tr>
				...
				<th class="list-hits" id="tableOrdering4" style="width:10%;">
