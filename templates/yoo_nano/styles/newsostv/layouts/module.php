...
$drop_img = '<img style="padding: 0px 3px 2px 0px" src="'.JURI::base().'templates/yoo_nano/styles/newsostv/images/title-bulet.png">';
...
switch ($style) {
	...
	case 'line':
		...
		$split_color	= 1;
		$subtitle		= 1;
		$title_template = '<h3 class="module-title">'.$drop_img.' %s</h3>';
		break;
	...
	case 'onair':
		$template      = 'on-air-monitor';
		$style         = 'mod-'.$style;
		$title_template = '<h3 class="onair-title">%s</h3>';
		break;

	case 'contents':
		$template      = 'contents-box';
		$style         = 'mod-'.$style;
		$title_template = '<h3 class="contents-title">%s</h3>';
		break;
