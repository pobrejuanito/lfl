...
if(in_array('hd-1', $is_plgplayer_plugin_array)) {
	$is_plgplayer_hd_enabled = '1';
	$key = array_search( 'hd-1' , $is_plgplayer_plugin_array);
	$is_plgplayer_hd_version = "hd-1";
	unset($is_plgplayer_plugin_array[$key]);
} else {
	$is_plgplayer_hd_enabled = $params->get('HDPluginEnabled');
	//set version of the plugin
	$is_plgplayer_hd_version = $params->get('HDPluginversion', "1");
	$is_plgplayer_hd_version = "hd-".$is_plgplayer_hd_version;
}
if($is_plgplayer_hd_enabled == '1' && $is_plgplayer_hd_version == "hd-1") {
