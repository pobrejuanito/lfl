...
if(in_array('captions-1', $is_plgplayer_plugin_array)) {
	$is_plgplayer_captions_enabled = '1';
	$key = array_search( 'captions-1' , $is_plgplayer_plugin_array);
	unset($is_plgplayer_plugin_array[$key]);
	//set version of the plugin
	$is_plgplayer_captions_version = "captions-1";
} else {
	$is_plgplayer_captions_enabled = $params->get('CaptionsPluginEnabled');
	//set version of the plugin
	$is_plgplayer_captions_version = $params->get('CaptionsPluginversion', "1");
	$is_plgplayer_captions_version = "captions-".$is_plgplayer_captions_version;
}
if($is_plgplayer_captions_enabled == '1' && $is_plgplayer_captions_version == 'captions-1') {
