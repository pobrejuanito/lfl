...
if(in_array('sharing-3', $is_plgplayer_plugin_array)) {
	$is_plgplayer_sharing_enabled = '1';
	$key = array_search( 'sharing-3' , $is_plgplayer_plugin_array);
	unset($is_plgplayer_plugin_array[$key]);
	//set version of the plugin
	$is_plgplayer_sharing_version = "sharing-3";
} else {
	$is_plgplayer_sharing_enabled = $params->get('SharingPluginEnabled', "0");
	//set version of the plugin
	$is_plgplayer_sharing_version = $params->get('SharingPluginversion', "3");
	$is_plgplayer_sharing_version = "sharing-".$is_plgplayer_sharing_version;
}
if($is_plgplayer_sharing_enabled == '1' && $is_plgplayer_sharing_version == 'sharing-3') {
