...
{
	YAHOO.ARISoft.page.pageManager.registerActionGroup('scaleAction',
	{
	...
	YAHOO.ARISoft.page.pageManager.registerAction('resultscale_list$ajax|delete',
	{
		group: 'scaleAction',
		completeMessage: '<?php AriWebHelper::displayResValue('Complete.ScaleDelete'); ?>'
	});
});
</script>